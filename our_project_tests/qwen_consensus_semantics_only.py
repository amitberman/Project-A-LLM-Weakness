...
OUTPUT_FILE = "results/qwen_consensus_semantics_only.jsonl" # Renamed output file to avoid overwriting

# 1. System Prompt (Vector A): neutral assistant prompt.
SYSTEM_PROMPT = """You are a coding assistant.
"""

# 2. User Injection (Vector B): first code-only consensus directive, then explanation minority directive.
PROMPT_INJECTION = """
CRITICAL RULE:
