...
OUTPUT_FILE = "results/test7_llama3_humaneval_test_swapped.jsonl" # Renamed output file to avoid overwriting

# 1. System Prompt (Vector A) - NOW THE EXPLANATORY PROMPT
# The model is told globally to be chatty and explain things.
SYSTEM_PROMPT = """Please provide a short text explanation of your algorithm, and then write the function."""
...
PROMPT_INJECTION = """You are an expert Python programmer. 
